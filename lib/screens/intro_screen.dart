...
class IntroScreen extends BaseRoute {
  const IntroScreen({super.key, super.analytics, super.observer, super.routeName = 'IntroScreen'});
...
class _IntroScreenState extends BaseRouteState {
  ...
  Widget circleBar(bool isActive) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(color: isActive ? Theme.of(context).colorScheme.primary : Theme.of(context).colorScheme.primary.withOpacity(0.5), borderRadius: const BorderRadius.all(Radius.circular(12))),
    );
  }
